...
export default function Contact() {
  ...
  return (
    <div
      id="contact"
      className="flex text-center flex-col gap-12 min-h-screen ml-4 overflow-hidden"
    >
          ...
          <div data-aos={"slide-up"} className="text-center mt-10">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                title="Github"
                onClick={() =>
                  window.open("https://github.com/aarthipriya2021", "_blank")
                }
              >
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/aarthipriya-a-sde/",
                    "_blank"
                  )
                }
              >
            ...
            <div className="mt-6 italic text-sm font-medium text-blue-500 ">
              ...
              <span>{new Date().getFullYear()} Aarthipriya A</span>
            </div>
          </div>
        </div>
        <ToastContainer
