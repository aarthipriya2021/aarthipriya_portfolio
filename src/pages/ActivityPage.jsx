              ...
              <div className="relative">
                ...
                >
                  ...
                  {userData.discord_status === "offline" ? (
                    <div className="bottom-2 dark-neutral-800 outline-neutral-800  left-3 ml-[55%] outline outline-4 w-5 h-5 rounded-full  absolute border-neutral-700 border-4 text-black " />
                  ) : null}
                </span>
              </div>
              <div className="py-2">
